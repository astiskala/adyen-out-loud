...
.NET 10 MAUI payment announcements for Android, iOS, macOS (Mac Catalyst), and Windows.
...
- [`../AGENTS.md`](../AGENTS.md) — architecture rules enforced by `AdyenOutLoud.ArchitectureTests`
