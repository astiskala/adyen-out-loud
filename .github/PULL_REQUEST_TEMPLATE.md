...
- [ ] Architecture rules preserved — see [AGENTS.md](../AGENTS.md#architecture-rules) (Core stays platform-independent, Worker domain code stays Cloudflare-free, no new circular references)
